function txt_mokouwin() {
	...
	txt("Don't worry about it, I had fun.", MOKOU.HAPPY),
	txt("I reckon I've got what I need... I'm sure you folks got places to go, and so do I.", AYA.NEUTRAL),
	txt("Make sure to say hi to me when I deliver the paper tomorrow, eh?", AYA.HAPPY),
	...
	txt("Maybe Sumireko isn't such a brat after all.", MOKOU.HAPPY),
	...
	txt("Não se preocupe com isso, eu me diverti.", MOKOU.HAPPY),
	txt("Acho que peguei tudo que precisava… Tenho certeza que vocês têm outros afazeres, e eu também.", AYA.NEUTRAL),
	txt("Me dê um oi quando eu for entregar o jornal amanhã, hein?", AYA.HAPPY),
	...
	txt("(Pode ser que a Sumireko não seja só uma pirralha no final das contas.)", MOKOU.HAPPY),
	...
	txt("No te preocupes, me divertí.", MOKOU.HAPPY),
	txt("Creo que tengo lo que necesito... Seguro que vosotros tenéis sitios a los que ir, y yo también.", AYA.NEUTRAL),
	txt("Asegúrate de saludarme cuando entregue el periódico mañana, ¿eh?", AYA.HAPPY),
