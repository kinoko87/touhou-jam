function txt_ayawin() {
	...
	txt("I can see it now... \"HOT ACTION ON THE COOL BREEZE: SNOW BOARD THE LATEST CRAZE!\"", AYA.EXTREMELYHAPPY),
	txt("Ha, can you fit all that on the front page?", MOKOU.EXTREMELYHAPPY),
	txt("Still underestimating my abilities after what I just did, eh Fujiwara-san?", AYA.FROWN),
	...
	txt("See you folks later, I gotta deadline to catch!", AYA.HAPPY),
	txt("I'll see ya around sometime. Maybe next time it'll be less eventful?", MOKOU.HAPPY),
	txt("I hope so. Hehe. I'll see you!", SUMIREKO.HAPPY),
	txt("(I wonder what'll happen when the paper comes out tomorrow...)", SUMIREKO.NEUTRAL),
	txt("(Hope it won't be too big a deal...no one reads it anyway.)", SUMIREKO.NEUTRAL),
	txt("(I'll worry about it later... I should warm up with a nice drink now!)", SUMIREKO.HAPPY),
	
	],[
	
	btxt(bk_title),
	txt("Ayayaya! Mal posso esperar pra botar isso no jornal!", AYA.EXTREMELYHAPPY),
	txt("Eu já consigo ver... \"ATIVIDADE CALOROSA NA BRISA GÉLIDA: SNOW BOARD A FEBRE DO MOMENTO!\"", AYA.EXTREMELYHAPPY),
	txt("Ha, e cabe tudo isso na capa?", MOKOU.EXTREMELYHAPPY),
	txt("Ainda tá subestimando minhas habilidades depois do que acabei de fazer é, Fujiwara-san?", AYA.FROWN),
	...
	txt("Vejo vocês mais tarde, tenho um prazo a cumprir!", AYA.HAPPY),
	txt("Te vejo depois. Talvez seja menos agitado da próxima vez?", MOKOU.HAPPY),
	txt("Espero que sim. Hehe. Até mais!", SUMIREKO.HAPPY),
	txt("(Me pergunto o que vai acontecer quando o jornal sair amanhã…),", SUMIREKO.NEUTRAL),
	txt("(Tomara que não vire grande coisa… ninguém lê mesmo.),", SUMIREKO.NEUTRAL),
	txt("(Depois me preocupo com isso… Agora eu vou me esquentar com uma bebida quentinha!),", SUMIREKO.HAPPY),
	
	],[
	
	btxt(bk_title),
	txt("Ayayaya! ¡Estoy deseando que salga esto en el periódico!", AYA.EXTREMELYHAPPY),
	txt("Ya puedo verlo... \"ACCIÓN CALIENTE EN LA BRISA FRESCA: ¡EL SNOWBOARD LA ÚLTIMA MODA!\".", AYA.EXTREMELYHAPPY),
	txt("Ja, ¿puedes meter todo eso en la portada?", MOKOU.EXTREMELYHAPPY),
	txt("Sigues subestimando mis habilidades después de lo que acabo de hacer, ¿eh Srta. Fujiwara?", AYA.FROWN),
	...
	txt("Nos vemos luego, tengo que cumplir un plazo.", AYA.HAPPY),
	txt("Ya nos veremos. ¿Quizá la próxima vez sea menos agitada?", MOKOU.HAPPY),
	txt("Eso espero. Jeje. ¡Nos vemos!", SUMIREKO.HAPPY),
	txt("(Me pregunto qué pasará cuando salga el periódico mañana...)", SUMIREKO.NEUTRAL),
	txt("(Espero que no sea para tanto...de todas formas nadie lo lee.)", SUMIREKO.NEUTRAL),
	txt("(Ya me preocuparé de eso más tarde... ¡Ahora debería calentarme con un buen trago!)", SUMIREKO.HAPPY),
