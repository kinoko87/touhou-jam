function txt_ayawin() {
	...
	txt("I hope so. Hehe. I'll see you!"),
	txt("(I wonder what'll happen when the paper comes out tomorrow...)", SUMIREKO.NEUTRAL),
	txt("(Hope it won't be too big a deal...no one reads it anyway.)"),
	...
	txt("Espero que sim. Hehe. Até mais!"),
	txt("(Me pergunto o que vai acontecer quando o jornal sair amanhã…),", SUMIREKO.NEUTRAL),
	txt("(Tomara que não vire grande coisa… ninguém lê mesmo.),"),
	...
	txt("Eso espero. Jeje. ¡Nos vemos!") ,
	txt("(Me pregunto qué pasará cuando salga el periódico mañana...)", SUMIREKO.NEUTRAL),
	txt("(Espero que no sea para tanto...de todas formas nadie lo lee.)"),
