...
global.textguy[$"sumireko"].addspr("EXTREMELYHAPPY");
global.textguy[$"sumireko"].addspr("FROWN");
...
global.textguy[$"mokou"].addspr("EXTREMELYHAPPY");
global.textguy[$"mokou"].addspr("FROWN");
global.textguy[$"mokou"].addspr("EXTREMELYSAD");
...
global.textguy[$"aya"].addspr("EXTREMELYHAPPY");
global.textguy[$"aya"].addspr("FROWN");
global.textguy[$"aya"].addspr("EXTREMELYSAD");
