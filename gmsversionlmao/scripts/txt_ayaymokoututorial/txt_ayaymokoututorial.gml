function txt_ayaymokoututorial() {
	...
	txt("Oh, and if you hit a ramp, you can do some cool tricks if you want![UP ARROW BUTTON]", SUMIREKO.HAPPY),
	...
	txt("Ah, e se você subir em uma rampa, você pode mandar umas manobras legais se quiser! [SETA PARA CIMA]", SUMIREKO.HAPPY),
	...
	txt("¡Oh, y si te encuentras con una rampa, puedes hacer algunos trucos chulos si quieres! [BOTÓN FLECHA ARRIBA]", SUMIREKO.HAPPY),
